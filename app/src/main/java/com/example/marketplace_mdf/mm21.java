...
public class mm21 extends NetworkConnection {
    ...
    protected void onNetworkChanged(boolean isConnected) {
        if (isConnected) {
            ...
            Intent intent = new Intent(mm21.this, NetworkConnection.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mm21);

        CardView cardVerde = findViewById(R.id.card21mm_verde);
        CardView cardBranco = findViewById(R.id.card21mm_branco);
        CardView cardCinza = findViewById(R.id.card21mm_cinza);
        CardView cardMadeira = findViewById(R.id.card21mm_madeira);
        CardView cardVermelho = findViewById(R.id.card21mm_vermelho);
        CardView cardPreto = findViewById(R.id.card21mm_preto);
    ...
    private void redirecionarParaPagamento() {
        ...
        Intent intent = new Intent(mm21.this, FormaPagamento.class);
        startActivity(intent);
    }
}
