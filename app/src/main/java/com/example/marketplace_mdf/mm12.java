...
public class mm12 extends NetworkConnection {
    ...
    protected void onNetworkChanged(boolean isConnected) {
        if (isConnected) {
            ...
            Intent intent = new Intent(mm12.this, NetworkConnection.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mm12);

        CardView cardVerde = findViewById(R.id.card12mm_verde);
        CardView cardBranco = findViewById(R.id.card12mm_branco);
        CardView cardCinza = findViewById(R.id.card12mm_cinza);
        CardView cardMadeira = findViewById(R.id.card12mm_madeira);
        CardView cardVermelho = findViewById(R.id.card12mm_vermelho);
        CardView cardPreto = findViewById(R.id.card12mm_preto);
    ...
    private void redirecionarParaPagamento() {
        ...
        Intent intent = new Intent(mm12.this, FormaPagamento.class);
        startActivity(intent);
    }
}
